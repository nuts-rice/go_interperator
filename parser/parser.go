...
//Construct root node of ast, *ast.Program. then iterates over every token in the input until encounters an token.EOF token
//then uses parseStatement to evaluate if to append statement to statements
...
func (p *Parser) parseIntegerLiteral() ast.Expression {
	...
	//strconv.ParseInt converts string in p.curToken.Literal into int64
